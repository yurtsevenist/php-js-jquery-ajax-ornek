...
<html lang="en">
  <head>
    ...
    <title>JAVA SCRİPT ÖRNEKLER</title>
      ...
      <div class="container">
        <div class="row">
            ...
            <form>
                ...
                <button type="button" onclick="topla();" class="btn btn-primary">Topla</button>
                <button type="button" onclick="cikar();" class="btn btn-secondary">Çıkar</button>
                <button type="button" onclick="carp();" class="btn btn-info">Çarp</button>
                <button type="button" onclick="bol();" class="btn btn-danger">Böl</button>
            </form>    
            </div>
        </div>
      </div>
